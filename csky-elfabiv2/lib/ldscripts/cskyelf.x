...
OUTPUT_ARCH(csky)
ENTRY(__start)
SEARCH_DIR("/ldhome/software/toolsbuild/slave2/workspace/Toolchain/release-csky-1/install/csky-elfabiv2/lib");
SECTIONS
{
  /* Read-only sections, merged into text segment: */
  PROVIDE (__executable_start = SEGMENT_START("text-segment", 0x60000000)); . = SEGMENT_START("text-segment", 0x60000000);
PROVIDE (__initial_sp = SEGMENT_START("text-segment", 0x60000000) + 0x80000 - 8);
  .interp         : { *(.interp) }
