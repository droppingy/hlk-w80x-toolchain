/* Generated automatically from machmode.def and config/csky/csky-modes.def
   by genmodes.  */
...
#define HAVE_TImode
  OImode,                  /* config/csky/csky-modes.def:39 */
#define HAVE_OImode
  CImode,                  /* config/csky/csky-modes.def:40 */
#define HAVE_CImode
  XImode,                  /* config/csky/csky-modes.def:41 */
#define HAVE_XImode
...
#define HAVE_UTAmode
  HFmode,                  /* config/csky/csky-modes.def:3 */
#define HAVE_HFmode
...
#define HAVE_DCmode
  V1QImode,                /* config/csky/csky-modes.def:19 */
#define HAVE_V1QImode
  V2QImode,                /* config/csky/csky-modes.def:20 */
#define HAVE_V2QImode
  V1HImode,                /* config/csky/csky-modes.def:23 */
#define HAVE_V1HImode
  V3QImode,                /* config/csky/csky-modes.def:21 */
#define HAVE_V3QImode
  V4QImode,                /* config/csky/csky-modes.def:6 */
#define HAVE_V4QImode
  V2HImode,                /* config/csky/csky-modes.def:6 */
#define HAVE_V2HImode
  V1SImode,                /* config/csky/csky-modes.def:26 */
#define HAVE_V1SImode
  V3HImode,                /* config/csky/csky-modes.def:24 */
#define HAVE_V3HImode
  V8QImode,                /* config/csky/csky-modes.def:7 */
#define HAVE_V8QImode
  V4HImode,                /* config/csky/csky-modes.def:7 */
#define HAVE_V4HImode
  V2SImode,                /* config/csky/csky-modes.def:7 */
#define HAVE_V2SImode
  V3SImode,                /* config/csky/csky-modes.def:27 */
#define HAVE_V3SImode
  V16QImode,               /* config/csky/csky-modes.def:8 */
#define HAVE_V16QImode
  V8HImode,                /* config/csky/csky-modes.def:8 */
#define HAVE_V8HImode
  V4SImode,                /* config/csky/csky-modes.def:8 */
#define HAVE_V4SImode
  V2DImode,                /* config/csky/csky-modes.def:8 */
#define HAVE_V2DImode
  V4QQmode,                /* config/csky/csky-modes.def:10 */
#define HAVE_V4QQmode
  V2HQmode,                /* config/csky/csky-modes.def:10 */
#define HAVE_V2HQmode
  V8QQmode,                /* config/csky/csky-modes.def:11 */
#define HAVE_V8QQmode
  V4HQmode,                /* config/csky/csky-modes.def:11 */
#define HAVE_V4HQmode
  V2SQmode,                /* config/csky/csky-modes.def:11 */
#define HAVE_V2SQmode
  V16QQmode,               /* config/csky/csky-modes.def:12 */
#define HAVE_V16QQmode
  V8HQmode,                /* config/csky/csky-modes.def:12 */
#define HAVE_V8HQmode
  V4SQmode,                /* config/csky/csky-modes.def:12 */
#define HAVE_V4SQmode
  V2DQmode,                /* config/csky/csky-modes.def:12 */
#define HAVE_V2DQmode
  V4UQQmode,               /* config/csky/csky-modes.def:13 */
#define HAVE_V4UQQmode
  V2UHQmode,               /* config/csky/csky-modes.def:13 */
#define HAVE_V2UHQmode
  V8UQQmode,               /* config/csky/csky-modes.def:14 */
#define HAVE_V8UQQmode
  V4UHQmode,               /* config/csky/csky-modes.def:14 */
#define HAVE_V4UHQmode
  V2USQmode,               /* config/csky/csky-modes.def:14 */
#define HAVE_V2USQmode
  V16UQQmode,              /* config/csky/csky-modes.def:15 */
#define HAVE_V16UQQmode
  V8UHQmode,               /* config/csky/csky-modes.def:15 */
#define HAVE_V8UHQmode
  V4USQmode,               /* config/csky/csky-modes.def:15 */
#define HAVE_V4USQmode
  V2UDQmode,               /* config/csky/csky-modes.def:15 */
#define HAVE_V2UDQmode
  V1HFmode,                /* config/csky/csky-modes.def:29 */
#define HAVE_V1HFmode
  V2HFmode,                /* config/csky/csky-modes.def:30 */
#define HAVE_V2HFmode
  V1SFmode,                /* config/csky/csky-modes.def:34 */
#define HAVE_V1SFmode
  V3HFmode,                /* config/csky/csky-modes.def:31 */
#define HAVE_V3HFmode
  V4HFmode,                /* config/csky/csky-modes.def:32 */
#define HAVE_V4HFmode
  V2SFmode,                /* config/csky/csky-modes.def:35 */
#define HAVE_V2SFmode
  V3SFmode,                /* config/csky/csky-modes.def:36 */
#define HAVE_V3SFmode
  V8HFmode,                /* config/csky/csky-modes.def:17 */
#define HAVE_V8HFmode
  V4SFmode,                /* config/csky/csky-modes.def:17 */
#define HAVE_V4SFmode
  V2DFmode,                /* config/csky/csky-modes.def:17 */
#define HAVE_V2DFmode
  ...
  MIN_MODE_VECTOR_INT = V1QImode,
  MAX_MODE_VECTOR_INT = V2DImode,

  MIN_MODE_VECTOR_FRACT = V4QQmode,
  MAX_MODE_VECTOR_FRACT = V2DQmode,

  MIN_MODE_VECTOR_UFRACT = V4UQQmode,
  MAX_MODE_VECTOR_UFRACT = V2UDQmode,
  ...
  MIN_MODE_VECTOR_FLOAT = V1HFmode,
...
mode_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case V8QQmode: return 8;
    case V4HQmode: return 8;
    case V2SQmode: return 8;
    case V16QQmode: return 16;
    case V8HQmode: return 16;
    case V4SQmode: return 16;
    case V2DQmode: return 16;
    case V4UQQmode: return 4;
    case V2UHQmode: return 4;
    case V8UQQmode: return 8;
    case V4UHQmode: return 8;
    case V2USQmode: return 8;
    case V16UQQmode: return 16;
    case V8UHQmode: return 16;
    case V4USQmode: return 16;
    case V2UDQmode: return 16;
    case V1HFmode: return 2;
    case V2HFmode: return 4;
    case V1SFmode: return 4;
    case V3HFmode: return 6;
    case V4HFmode: return 8;
    case V2SFmode: return 8;
    case V3SFmode: return 12;
...
mode_nunits_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case V8QQmode: return 8;
    case V4HQmode: return 4;
    case V2SQmode: return 2;
    case V16QQmode: return 16;
    case V8HQmode: return 8;
    case V4SQmode: return 4;
    case V2DQmode: return 2;
    case V4UQQmode: return 4;
    case V2UHQmode: return 2;
    case V8UQQmode: return 8;
    case V4UHQmode: return 4;
    case V2USQmode: return 2;
    case V16UQQmode: return 16;
    case V8UHQmode: return 8;
    case V4USQmode: return 4;
    case V2UDQmode: return 2;
    case V1HFmode: return 1;
    case V2HFmode: return 2;
    case V1SFmode: return 1;
    case V3HFmode: return 3;
    case V4HFmode: return 4;
    case V2SFmode: return 2;
    case V3SFmode: return 3;
...
mode_inner_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case V8QQmode: return QQmode;
    case V4HQmode: return HQmode;
    case V2SQmode: return SQmode;
    case V16QQmode: return QQmode;
    case V8HQmode: return HQmode;
    case V4SQmode: return SQmode;
    case V2DQmode: return DQmode;
    case V4UQQmode: return UQQmode;
    case V2UHQmode: return UHQmode;
    case V8UQQmode: return UQQmode;
    case V4UHQmode: return UHQmode;
    case V2USQmode: return USQmode;
    case V16UQQmode: return UQQmode;
    case V8UHQmode: return UHQmode;
    case V4USQmode: return USQmode;
    case V2UDQmode: return UDQmode;
    case V1HFmode: return HFmode;
    case V2HFmode: return HFmode;
    case V1SFmode: return SFmode;
    case V3HFmode: return HFmode;
    case V4HFmode: return HFmode;
    case V2SFmode: return SFmode;
    case V3SFmode: return SFmode;
...
mode_unit_size_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case V2HQmode: return 2;
    case V8QQmode: return 1;
    case V4HQmode: return 2;
    case V2SQmode: return 4;
    case V16QQmode: return 1;
    case V8HQmode: return 2;
    case V4SQmode: return 4;
    case V2DQmode: return 8;
    case V4UQQmode: return 1;
    case V2UHQmode: return 2;
    case V8UQQmode: return 1;
    case V4UHQmode: return 2;
    case V2USQmode: return 4;
    case V16UQQmode: return 1;
    case V8UHQmode: return 2;
    case V4USQmode: return 4;
    case V2UDQmode: return 8;
    case V1HFmode: return 2;
    case V2HFmode: return 2;
    case V1SFmode: return 4;
    case V3HFmode: return 2;
    case V4HFmode: return 2;
    case V2SFmode: return 4;
    case V3SFmode: return 4;
...
mode_unit_precision_inline (machine_mode mode)
{
  ...
  switch (mode)
    ...
    case V8QQmode: return 1*BITS_PER_UNIT;
    case V4HQmode: return 2*BITS_PER_UNIT;
    case V2SQmode: return 4*BITS_PER_UNIT;
    case V16QQmode: return 1*BITS_PER_UNIT;
    case V8HQmode: return 2*BITS_PER_UNIT;
    case V4SQmode: return 4*BITS_PER_UNIT;
    case V2DQmode: return 8*BITS_PER_UNIT;
    case V4UQQmode: return 1*BITS_PER_UNIT;
    case V2UHQmode: return 2*BITS_PER_UNIT;
    case V8UQQmode: return 1*BITS_PER_UNIT;
    case V4UHQmode: return 2*BITS_PER_UNIT;
    case V2USQmode: return 4*BITS_PER_UNIT;
    case V16UQQmode: return 1*BITS_PER_UNIT;
    case V8UHQmode: return 2*BITS_PER_UNIT;
    case V4USQmode: return 4*BITS_PER_UNIT;
    case V2UDQmode: return 8*BITS_PER_UNIT;
    case V1HFmode: return 2*BITS_PER_UNIT;
    case V2HFmode: return 2*BITS_PER_UNIT;
    case V1SFmode: return 4*BITS_PER_UNIT;
    case V3HFmode: return 2*BITS_PER_UNIT;
    case V4HFmode: return 2*BITS_PER_UNIT;
    case V2SFmode: return 4*BITS_PER_UNIT;
    case V3SFmode: return 4*BITS_PER_UNIT;
