...
#endif
#ifdef GENERATOR_FILE
extern int flag_duplicate_loop_header;
#else
  int x_flag_duplicate_loop_header;
#define flag_duplicate_loop_header global_options.x_flag_duplicate_loop_header
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_gimple_fold_builtin;
#else
  int x_flag_gimple_fold_builtin;
#define flag_gimple_fold_builtin global_options.x_flag_gimple_fold_builtin
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_ivopt_loop_speedup;
#else
  int x_flag_ivopt_loop_speedup;
#define flag_ivopt_loop_speedup global_options.x_flag_ivopt_loop_speedup
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_real_cst;
#else
  int x_flag_real_cst;
#define flag_real_cst global_options.x_flag_real_cst
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_sharp_wrap;
#else
  int x_flag_sharp_wrap;
#define flag_sharp_wrap global_options.x_flag_sharp_wrap
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_arg_mode_compatible;
#else
  int x_flag_arg_mode_compatible;
#define flag_arg_mode_compatible global_options.x_flag_arg_mode_compatible
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_csky_doloop;
#else
  int x_flag_csky_doloop;
#define flag_csky_doloop global_options.x_flag_csky_doloop
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern enum float_abi_type csky_float_abi;
#else
  enum float_abi_type x_csky_float_abi;
#define csky_float_abi global_options.x_csky_float_abi
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_induction_speedup;
#else
  int x_flag_induction_speedup;
#define flag_induction_speedup global_options.x_flag_induction_speedup
#endif
#ifdef GENERATOR_FILE
extern int flag_lra;
#else
  int x_flag_lra;
#define flag_lra global_options.x_flag_lra
#endif
#ifdef GENERATOR_FILE
extern int flag_pieces_move_speedup;
#else
  int x_flag_pieces_move_speedup;
#define flag_pieces_move_speedup global_options.x_flag_pieces_move_speedup
#endif
#ifdef GENERATOR_FILE
extern int flag_required_attr_fpu_abi;
#else
  int x_flag_required_attr_fpu_abi;
#define flag_required_attr_fpu_abi global_options.x_flag_required_attr_fpu_abi
#endif
#ifdef GENERATOR_FILE
extern int flag_required_printf;
#else
  int x_flag_required_printf;
#define flag_required_printf global_options.x_flag_required_printf
#endif
#ifdef GENERATOR_FILE
extern int flag_required_scanf;
#else
  int x_flag_required_scanf;
#define flag_required_scanf global_options.x_flag_required_scanf
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_small_pieces_fold;
#else
  int x_flag_small_pieces_fold;
#define flag_small_pieces_fold global_options.x_flag_small_pieces_fold
#endif
#ifdef GENERATOR_FILE
extern int flag_spill_regs;
#else
  int x_flag_spill_regs;
#define flag_spill_regs global_options.x_flag_spill_regs
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int vdsp_noisa;
#else
  int x_vdsp_noisa;
#define vdsp_noisa global_options.x_vdsp_noisa
#endif
#ifdef GENERATOR_FILE
extern int flag_csky_vdsp_width;
#else
  int x_flag_csky_vdsp_width;
#define flag_csky_vdsp_width global_options.x_flag_csky_vdsp_width
#endif
#ifdef GENERATOR_FILE
extern int flag_csky_vdspv2;
#else
  int x_flag_csky_vdspv2;
#define flag_csky_vdspv2 global_options.x_flag_csky_vdspv2
#endif
#ifdef GENERATOR_FILE
...
#define MASK_HIGH_REGISTERS (1 << 13)
#define MASK_ATTRIBUTE_ISR (1 << 14)
#define MASK_SECURITY (1 << 15)
#define MASK_MP (1 << 16)
#define MASK_MULTIPLE_STLD (1 << 17)
#define MASK_PUSHPOP (1 << 18)
#define MASK_SMART (1 << 19)
#define MASK_STACK_SIZE (1 << 20)
#define MASK_STRICT_ALIGNMENT (1 << 21)
#define MASK_W_FIELD (1 << 22)
...
enum opt_code
{
  ...
  OPT_fduplicate_loop_header = 654,          /* -fduplicate-loop-header */
  ...
  OPT_fgimple_fold_builtin = 713,            /* -fgimple-fold-builtin */
  OPT_fgnat_encodings_ = 714,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 715,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 716,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 717,                         /* -fgnu-tm */
  OPT_fgnu_unique = 718,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 719,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 720,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 721,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 722,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 723,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 724,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 725,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 726,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 727,                       /* -fgraphite */
  OPT_fgraphite_identity = 728,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 729,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 730, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 731, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 732,           /* -fhash-synchronization */
  /* OPT_fhelp = 733, */                     /* -fhelp */
  /* OPT_fhelp_ = 734, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 735,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 736, */                /* -fhonor-std */
  OPT_fhosted = 737,                         /* -fhosted */
  /* OPT_fhuge_objects = 738, */             /* -fhuge-objects */
  OPT_fident = 739,                          /* -fident */
  OPT_fif_conversion = 740,                  /* -fif-conversion */
  OPT_fif_conversion2 = 741,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 742,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 743,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 744,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 745,             /* -fimplicit-templates */
  OPT_findirect_classes = 746,               /* -findirect-classes */
  OPT_findirect_dispatch = 747,              /* -findirect-dispatch */
  OPT_findirect_inlining = 748,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 749,         /* -finhibit-size-directive */
  OPT_finit_character_ = 750,                /* -finit-character= */
  OPT_finit_integer_ = 751,                  /* -finit-integer= */
  OPT_finit_local_zero = 752,                /* -finit-local-zero */
  OPT_finit_logical_ = 753,                  /* -finit-logical= */
  OPT_finit_real_ = 754,                     /* -finit-real= */
  OPT_finline = 755,                         /* -finline */
  OPT_finline_atomics = 756,                 /* -finline-atomics */
  OPT_finline_functions = 757,               /* -finline-functions */
  OPT_finline_functions_called_once = 758,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 759, */            /* -finline-limit- */
  OPT_finline_limit_ = 760,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 761,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 762,         /* -finline-small-functions */
  OPT_finput_charset_ = 763,                 /* -finput-charset= */
  OPT_finstrument_functions = 764,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 765,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 766,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 767,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 768,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 769,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 770,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 771,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 772,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 773,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 774,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 775,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 776, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 777,                    /* -fipa-profile */
  OPT_fipa_pta = 778,                        /* -fipa-pta */
  OPT_fipa_pure_const = 779,                 /* -fipa-pure-const */
  OPT_fipa_ra = 780,                         /* -fipa-ra */
  OPT_fipa_reference = 781,                  /* -fipa-reference */
  OPT_fipa_sra = 782,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 783, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 784,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 785,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 786,              /* -fira-loop-pressure */
  OPT_fira_region_ = 787,                    /* -fira-region= */
  OPT_fira_share_save_slots = 788,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 789,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 790,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 791,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 792,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 793,               /* -fivar-visibility= */
  OPT_fivopt_loop_speedup = 794,             /* -fivopt-loop-speedup */
  ...
  OPT_freal_cst = 927,                       /* -freal-cst */
  OPT_frealloc_lhs = 928,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 929,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 930,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 931,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 932,                /* -frecord-marker=8 */
  OPT_frecursive = 933,                      /* -frecursive */
  OPT_freduced_reflection = 934,             /* -freduced-reflection */
  OPT_free = 935,                            /* -free */
  OPT_freg_struct_return = 936,              /* -freg-struct-return */
  /* OPT_fregmove = 937, */                  /* -fregmove */
  OPT_frename_registers = 938,               /* -frename-registers */
  OPT_freorder_blocks = 939,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 940,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 941,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 942,              /* -freorder-functions */
  OPT_frepack_arrays = 943,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 944,           /* -freplace-objc-classes */
  OPT_frepo = 945,                           /* -frepo */
  OPT_freport_bug = 946,                     /* -freport-bug */
  OPT_frequire_return_statement = 947,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 948,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 949, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 950,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 951,                    /* -fresolution= */
  ...
  OPT_fsharp_wrap = 991,                     /* -fsharp-wrap */
  OPT_fshort_enums = 992,                    /* -fshort-enums */
  OPT_fshort_wchar = 993,                    /* -fshort-wchar */
  OPT_fshow_column = 994,                    /* -fshow-column */
  OPT_fshrink_wrap = 995,                    /* -fshrink-wrap */
  OPT_fsign_zero = 996,                      /* -fsign-zero */
  OPT_fsignaling_nans = 997,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 998,               /* -fsigned-bitfields */
  OPT_fsigned_char = 999,                    /* -fsigned-char */
  OPT_fsigned_zeros = 1000,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1001,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1002,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1003,            /* -fsized-deallocation */
  OPT_fsource_filename_ = 1004,              /* -fsource-filename= */
  OPT_fsource_ = 1005,                       /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 1006,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 1007,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1008,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1009,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1010, */                /* -fsquangle */
  OPT_fssa_backprop = 1011,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1012,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1013,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1014,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1015, */             /* -fstack-check */
  OPT_fstack_check_ = 1016,                  /* -fstack-check= */
  OPT_fstack_limit = 1017,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1018,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1019,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1020,               /* -fstack-protector */
  OPT_fstack_protector_all = 1021,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1022,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1023,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1024,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1025,                   /* -fstack-usage */
  OPT_fstats = 1026,                         /* -fstats */
  OPT_fstdarg_opt = 1027,                    /* -fstdarg-opt */
  OPT_fstore_check = 1028,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1029, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1030,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1031,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1032,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1033, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1034,     /* -fstrict-volatile-bitfields */
  ...
  OPT_fuse_boehm_gc = 1112,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1113,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1114,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1115,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1116,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1117,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1118,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1119,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1120,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1121,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1122,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1123,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1124, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1125,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1126,                   /* -fverbose-asm */
  /* OPT_fversion = 1127, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1128,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1129,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1130,                   /* -fvisibility= */
  OPT_fvpt = 1131,                           /* -fvpt */
  /* OPT_fvtable_gc = 1132, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1133, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1134,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1135,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1136,                     /* -fvtv-debug */
  OPT_fweak = 1137,                          /* -fweak */
  OPT_fweb = 1138,                           /* -fweb */
  /* OPT_fwhole_file = 1139, */              /* -fwhole-file */
  OPT_fwhole_program = 1140,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1141,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1142,             /* -fworking-directory */
  OPT_fwpa = 1143,                           /* -fwpa */
  OPT_fwpa_ = 1144,                          /* -fwpa= */
  OPT_fwrapv = 1145,                         /* -fwrapv */
  /* OPT_fxref = 1146, */                    /* -fxref */
  /* OPT_fzee = 1147, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1148,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1149,                     /* -fzero-link */
  OPT_g = 1150,                              /* -g */
  OPT_gant = 1151,                           /* -gant */
  OPT_gcoff = 1152,                          /* -gcoff */
  OPT_gdwarf = 1153,                         /* -gdwarf */
  OPT_gdwarf_ = 1154,                        /* -gdwarf- */
  OPT_gen_decls = 1155,                      /* -gen-decls */
  OPT_ggdb = 1156,                           /* -ggdb */
  OPT_ggnu_pubnames = 1157,                  /* -ggnu-pubnames */
  OPT_gnat = 1158,                           /* -gnat */
  OPT_gnatO = 1159,                          /* -gnatO */
  OPT_gno_pubnames = 1160,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1161,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1162,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1163,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1164,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1165,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1166,                   /* -gsplit-dwarf */
  OPT_gstabs = 1167,                         /* -gstabs */
  OPT_gstabs_ = 1168,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1169,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1170,                        /* -gtoggle */
  OPT_gvms = 1171,                           /* -gvms */
  ...
  OPT_manchor = 1192,                        /* -manchor */
  OPT_march_ = 1193,                         /* -march= */
  OPT_march_ck803s = 1194,                   /* -march=ck803s */
  OPT_marg_mode_compatible = 1195,           /* -marg-mode-compatible */
  OPT_mbacktrace = 1196,                     /* -mbacktrace */
  OPT_mbig_endian = 1197,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1198,                  /* -mbranch-cost= */
  OPT_mccrt = 1199,                          /* -mccrt */
  OPT_mconstpool = 1200,                     /* -mconstpool */
  OPT_mcp = 1201,                            /* -mcp */
  OPT_mcpu_ = 1202,                          /* -mcpu= */
  OPT_mcse_cc = 1203,                        /* -mcse-cc */
  OPT_mdiv = 1204,                           /* -mdiv */
  OPT_mdoloop = 1205,                        /* -mdoloop */
  OPT_mdouble_float = 1206,                  /* -mdouble-float */
  OPT_mdsp = 1207,                           /* -mdsp */
  OPT_medsp = 1208,                          /* -medsp */
  OPT_melrw = 1209,                          /* -melrw */
  OPT_mfdivdu = 1210,                        /* -mfdivdu */
  OPT_mfloat_abi_ = 1211,                    /* -mfloat-abi= */
  /* OPT_mfloat_abi_v1 = 1212, */            /* -mfloat-abi=v1 */
  /* OPT_mfloat_abi_v2 = 1213, */            /* -mfloat-abi=v2 */
  OPT_mfpu_ = 1214,                          /* -mfpu= */
  /* OPT_mhard_float = 1215, */              /* -mhard-float */
  OPT_mhigh_registers = 1216,                /* -mhigh-registers */
  OPT_mistack = 1217,                        /* -mistack */
  OPT_mlittle_endian = 1218,                 /* -mlittle-endian */
  OPT_mloop_induction_speedup = 1219,        /* -mloop-induction-speedup */
  OPT_mlra = 1220,                           /* -mlra */
  OPT_mmac = 1221,                           /* -mmac */
  OPT_mmp = 1222,                            /* -mmp */
  OPT_mmultiple_stld = 1223,                 /* -mmultiple-stld */
  OPT_mpieces_move_speedup = 1224,           /* -mpieces-move-speedup */
  OPT_mpushpop = 1225,                       /* -mpushpop */
  OPT_mrequired_attr_fpu_abi = 1226,         /* -mrequired-attr-fpu-abi */
  OPT_mrequired_printf = 1227,               /* -mrequired-printf */
  OPT_mrequired_scanf = 1228,                /* -mrequired-scanf */
  OPT_msched_prolog = 1229,                  /* -msched-prolog */
  OPT_msim = 1230,                           /* -msim */
  OPT_msmall_pieces_fold = 1231,             /* -msmall-pieces-fold */
  OPT_msmart = 1232,                         /* -msmart */
  /* OPT_msoft_float = 1233, */              /* -msoft-float */
  OPT_mspill_regs = 1234,                    /* -mspill-regs */
  OPT_mstack_size = 1235,                    /* -mstack-size */
  /* OPT_mstm = 1236, */                     /* -mstm */
  OPT_mstrict_align = 1237,                  /* -mstrict-align */
  OPT_mtrust = 1238,                         /* -mtrust */
  OPT_mvdsp_noisa = 1239,                    /* -mvdsp-noisa */
  OPT_mvdsp_width_ = 1240,                   /* -mvdsp-width= */
  OPT_mvdspv2 = 1241,                        /* -mvdspv2 */
  OPT_mwide_bitfields = 1242,                /* -mwide-bitfields */
  OPT_n = 1243,                              /* -n */
  ...
  OPT_pie = 1259,                            /* -pie */
  OPT_pipe = 1260,                           /* -pipe */
  OPT_print_file_name_ = 1261,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1262,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1263,          /* -print-multi-directory */
  OPT_print_multi_lib = 1264,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1265,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1266,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1267,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1268,               /* -print-prog-name= */
  OPT_print_search_dirs = 1269,              /* -print-search-dirs */
  OPT_print_sysroot = 1270,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1271,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1272,                          /* -quiet */
  OPT_r = 1273,                              /* -r */
  OPT_remap = 1274,                          /* -remap */
  OPT_s = 1275,                              /* -s */
  OPT_s_bc_abi = 1276,                       /* -s-bc-abi */
  OPT_save_temps = 1277,                     /* -save-temps */
  OPT_save_temps_ = 1278,                    /* -save-temps= */
  OPT_shared = 1279,                         /* -shared */
  OPT_shared_libgcc = 1280,                  /* -shared-libgcc */
  /* OPT_specs = 1281, */                    /* -specs */
  OPT_specs_ = 1282,                         /* -specs= */
  OPT_static = 1283,                         /* -static */
  OPT_static_libasan = 1284,                 /* -static-libasan */
  OPT_static_libgcc = 1285,                  /* -static-libgcc */
  OPT_static_libgcj = 1286,                  /* -static-libgcj */
  OPT_static_libgfortran = 1287,             /* -static-libgfortran */
  OPT_static_libgo = 1288,                   /* -static-libgo */
  OPT_static_liblsan = 1289,                 /* -static-liblsan */
  OPT_static_libmpx = 1290,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1291,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1292,               /* -static-libstdc++ */
  OPT_static_libtsan = 1293,                 /* -static-libtsan */
  OPT_static_libubsan = 1294,                /* -static-libubsan */
  /* OPT_std_c__03 = 1295, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1296, */                /* -std=c++0x */
  OPT_std_c__11 = 1297,                      /* -std=c++11 */
  OPT_std_c__14 = 1298,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1299, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1300, */                /* -std=c++1y */
  OPT_std_c__1z = 1301,                      /* -std=c++1z */
  ...
  OPT_std_gnu__14 = 1317,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1318, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1319, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1320,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1321,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1322,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1323, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1324, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1325,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1326,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1327, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1328, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1329,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1330, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1331, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1332, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1333,                     /* -std=legacy */
  OPT_symbolic = 1334,                       /* -symbolic */
  OPT_t = 1335,                              /* -t */
  OPT_time = 1336,                           /* -time */
  OPT_time_ = 1337,                          /* -time= */
  OPT_traditional = 1338,                    /* -traditional */
  OPT_traditional_cpp = 1339,                /* -traditional-cpp */
  OPT_trigraphs = 1340,                      /* -trigraphs */
  OPT_u = 1341,                              /* -u */
  OPT_undef = 1342,                          /* -undef */
  OPT_v = 1343,                              /* -v */
  OPT_version = 1344,                        /* -version */
  OPT_w = 1345,                              /* -w */
  OPT_wrapper = 1346,                        /* -wrapper */
  OPT_x = 1347,                              /* -x */
  OPT_z = 1348,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
